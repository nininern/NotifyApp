...
public class MainActivity extends AppCompatActivity {
    ...
    private void sendNotification(){
        ...
        PendingIntent notifPendingIntent=PendingIntent.getActivity(this,NOTIFICATION_ID,notifIntent,PendingIntent.FLAG_UPDATE_CURRENT);
    ...
    private void updateNotification(){
        ...
        Intent cancelIntent=new Intent(ACTION_UPDATE_NOTIFICATION);
        ...
        NotificationCompat.Builder notifyBuilder=
                ...
                .setStyle(new NotificationCompat.BigPictureStyle().bigPicture(image).setBigContentTitle("Notification Updated!"));
        Notification notification=notifyBuilder.build();
        notificationManager.notify(NOTIFICATION_ID, notification);
    }
